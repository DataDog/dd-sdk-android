...
```
# device=... sdk=... abi=... emulator=0 android_user=0 compile_filter=... compile_status=... perf_mode=... blocks=... runs=... warmup=... animations=0 fp=... launcher=... airplane=0 baseline_md5=... treatment_md5=... label_a=... label_b=... expect_a=0 expect_b=1 app_trace_id=...
