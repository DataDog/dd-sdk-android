...
internal constructor(
    ...
    constructor(
        ...
        /**
         * Sets the remote configuration identifier used to fetch SDK settings from the Datadog CDN.
         *
         * @param remoteConfigurationId the opaque identifier assigned during application onboarding
         * in the Datadog UI.
         */
