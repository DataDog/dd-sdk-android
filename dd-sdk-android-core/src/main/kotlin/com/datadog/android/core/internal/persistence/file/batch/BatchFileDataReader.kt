...
internal class BatchFileDataReader(
    ...
    private fun releaseFile(
        ...
        if (file != null) {
            ...
            DdSdkAndroidCoreLogger(internalLogger).logWarningUnknownBatchId(fileName = fileName)
        }
    }
    ...
    private fun deleteFile(file: File) {
        if (!fileMover.delete(file)) {
            DdSdkAndroidCoreLogger(internalLogger).logWarningDeleteFailed(path = file.path)
        }
    }
