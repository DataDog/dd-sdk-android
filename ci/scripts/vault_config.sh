...
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__E2E_CONFIG_JSON | config.json for uploading an end-to-end APK to the Mobile Integration org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__E2E_API_KEY | API key for uploading an end-to-end APK to the Mobile Integration org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__E2E_APP_KEY | App key for uploading an end-to-end APK to the Mobile Integration org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__E2E_MOBILE_APP_ID | Application ID for uploading an end-to-end APK to the Mobile Integration org."
...
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__WEBVIEW_CONFIG_JSON | config.json for uploading an end-to-end APK (for webview integration) to the RUM Synthetics org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__WEBVIEW_API_KEY | API key for uploading an end-to-end APK (for webview integration) to the RUM Synthetics org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__WEBVIEW_APP_KEY | App key for uploading an end-to-end APK (for webview integration) to the RUM Synthetics org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__WEBVIEW_MOBILE_APP_ID | Application ID for uploading an end-to-end APK (for webview integration) to the RUM Synthetics org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__BENCHMARK_CONFIG_JSON | config.json for uploading a benchmark APK to the Mobile Integration org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__BENCHMARK_API_KEY | API key for uploading a benchmark APK to the Mobile Integration org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__BENCHMARK_APP_KEY | App key for uploading a benchmark APK to the Mobile Integration org."
DD_ANDROID_SECRETS[$((idx++))]="$DD_ANDROID_SECRET__BENCHMARK_MOBILE_APP_ID | Application ID for uploading a benchmark APK to the Mobile Integration org."
fi
