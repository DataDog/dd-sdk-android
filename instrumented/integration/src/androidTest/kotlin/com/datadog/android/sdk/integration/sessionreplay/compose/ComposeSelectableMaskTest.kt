...
internal class ComposeSelectableMaskTest : BaseSessionReplayTest<ComposeSelectableActivity>() {
    ...
    companion object {
        const val EXPECTED_PAYLOAD_FILE_NAME = "sr_compose_selectable_mask_payload.json"
    }
}
