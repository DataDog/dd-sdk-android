...
internal class ComposeTypographyAllowTest : BaseSessionReplayTest<ComposeTypographyActivity>() {

    @get:Rule
    val rule = SessionReplayTestRule(
        ComposeTypographyActivity::class.java,
    ...
    companion object {
        const val EXPECTED_PAYLOAD_FILE_NAME = "sr_compose_typography_allow_payload.json"
    }
}
