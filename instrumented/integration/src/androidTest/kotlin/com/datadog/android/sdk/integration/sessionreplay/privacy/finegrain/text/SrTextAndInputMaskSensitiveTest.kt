...
internal class SrTextAndInputMaskSensitiveTest :
    ...
    val rule = SessionReplayTestRule(
        ...
        keepRequests = true,
        intentExtras = mapOf(
            SR_TEXT_AND_INPUT_PRIVACY to TextAndInputPrivacy.MASK_SENSITIVE_INPUTS
        )
    )

    @Test
    fun assessMaskSensitiveInputsPayload() {
        runInstrumentationScenario()
        assertStaticTextVisible(rule, "Default Text View")
        assertInputTextVisible(rule, "Regular text input")
