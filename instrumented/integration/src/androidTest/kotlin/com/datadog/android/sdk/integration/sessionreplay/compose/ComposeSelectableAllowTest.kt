...
internal class ComposeSelectableAllowTest : BaseSessionReplayTest<ComposeSelectableActivity>() {

    @get:Rule
    val rule = SessionReplayTestRule(
        ComposeSelectableActivity::class.java,
    ...
    companion object {
        const val EXPECTED_PAYLOAD_FILE_NAME = "sr_compose_selectable_allow_payload.json"
    }
}
