...
internal class SrTouchMaskTest : BaseSessionReplayTest<SessionReplayTouchActivity>() {
    ...
    @Test
    fun assessTouchRecordsWithMask() {
        runTouchScenario()
        ...
        ConditionWatcher {
            ...
            assertThat(touchRecords)
                .describedAs("Should NOT capture touch records with MASK privacy")
                .isEmpty()
