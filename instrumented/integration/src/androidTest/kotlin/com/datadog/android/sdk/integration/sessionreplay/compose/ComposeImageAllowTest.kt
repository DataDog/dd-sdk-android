...
internal class ComposeImageAllowTest : BaseSessionReplayTest<ComposeImageActivity>() {
    ...
    companion object {
        const val EXPECTED_PAYLOAD_FILE_NAME = "sr_compose_image_allow_payload.json"
    }
}
