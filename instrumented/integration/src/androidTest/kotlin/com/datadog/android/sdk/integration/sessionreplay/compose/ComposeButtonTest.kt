...
internal class ComposeButtonTest : BaseSessionReplayTest<ComposeButtonActivity>() {

    @get:Rule
    val rule = SessionReplayTestRule(
        ComposeButtonActivity::class.java,
    ...
    companion object {
        const val EXPECTED_PAYLOAD_FILE_NAME = "sr_compose_button_payload.json"
    }
}
