...
import com.datadog.android.core.internal.net.HttpSpec.Method.isMethodWithBody
...
internal class CronetClientWrapper(
    ...
    override suspend fun execute(request: TestRequest): ClientExecutionResult =
        suspendCancellableCoroutine { continuation ->
            ...
            val engine = DatadogCronetEngine.Builder(context)
                .enableApmInstrumentation(
                    ApmNetworkInstrumentationConfiguration(tracedHosts)
    ...
    private fun UrlRequest.Builder.setMethod(method: String, body: String?) = apply {
        ...
        if (body != null && isMethodWithBody(method)) {
            addHeader(HttpSpec.Headers.CONTENT_TYPE, HttpSpec.ContentType.TEXT_PLAIN)
