...
internal class SrPlaceholdersMaskAllTest :
    ...
    val rule = SessionReplayTestRule(
        ...
        keepRequests = true,
        intentExtras = mapOf(SR_IMAGE_PRIVACY_LEVEL to ImagePrivacy.MASK_ALL)
    )
    ...
    companion object {
        const val EXPECTED_PAYLOAD_FILE_NAME = "sr_placeholders_mask_all_payload.json"
    }
}
