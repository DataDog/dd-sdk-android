...
import static com.datadog.trace.api.iast.telemetry.IastMetric.Scope.REQUEST;
...
import com.datadog.trace.api.iast.telemetry.IastMetric.Tag;
import com.datadog.trace.api.telemetry.MetricCollector;
...
public class IastMetricCollector implements MetricCollector<IastMetricCollector.IastMetricData> {
  ...
  public static class IastMetricData extends Metric {
