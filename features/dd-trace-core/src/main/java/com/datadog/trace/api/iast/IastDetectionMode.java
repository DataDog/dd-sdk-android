...
import static com.datadog.trace.api.ConfigDefaults.DEFAULT_IAST_DEDUPLICATION_ENABLED;
import static com.datadog.trace.api.ConfigDefaults.DEFAULT_IAST_MAX_CONCURRENT_REQUESTS;
import static com.datadog.trace.api.ConfigDefaults.DEFAULT_IAST_MAX_RANGE_COUNT;
import static com.datadog.trace.api.ConfigDefaults.DEFAULT_IAST_REQUEST_SAMPLING;
import static com.datadog.trace.api.ConfigDefaults.DEFAULT_IAST_VULNERABILITIES_PER_REQUEST;
import static com.datadog.trace.api.config.IastConfig.IAST_DEDUPLICATION_ENABLED;
import static com.datadog.trace.api.config.IastConfig.IAST_MAX_CONCURRENT_REQUESTS;
import static com.datadog.trace.api.config.IastConfig.IAST_MAX_RANGE_COUNT;
import static com.datadog.trace.api.config.IastConfig.IAST_REQUEST_SAMPLING;
import static com.datadog.trace.api.config.IastConfig.IAST_VULNERABILITIES_PER_REQUEST;
