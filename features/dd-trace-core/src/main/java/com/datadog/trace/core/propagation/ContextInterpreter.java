...
import static com.datadog.trace.core.propagation.HttpCodec.CF_CONNECTING_IP_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.CF_CONNECTING_IP_V6_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.FASTLY_CLIENT_IP_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.FORWARDED_FOR_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.FORWARDED_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.TRUE_CLIENT_IP_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.USER_AGENT_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.X_CLIENT_IP_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.X_CLUSTER_CLIENT_IP_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.X_FORWARDED_FOR_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.X_FORWARDED_HOST_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.X_FORWARDED_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.X_FORWARDED_PORT_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.X_FORWARDED_PROTO_KEY;
import static com.datadog.trace.core.propagation.HttpCodec.X_REAL_IP_KEY;
