...
package com.datadog.android.sessionreplay.compose.mappers
...
class ComposeWireframeMapper(
    ...
    private fun createComposerWireframes(composer: Composer, density: Float): List<MobileSegment.Wireframe> {
        ...
        val hitRatio = ComposeContext.contextCache.hitCount() * 100.0 / totalQuery
        val missRatio = ComposeContext.contextCache.missCount() * 100.0 / totalQuery
