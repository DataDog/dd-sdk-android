...
import com.datadog.android.internal.ComponentIdManagerImpl
...
internal class RumFeature(
    ...
    internal var componentIdManager: ComponentIdManager = NoOpComponentIdManager()
    ...
    override fun onInitialize(appContext: Context) {
        ...
        componentIdManager = ComponentIdManagerImpl(appContext.packageName)
        // Store in feature context for cross-feature access (e.g., Session Replay)
        sdkCore.updateFeatureContext(name) { context ->
            context[ComponentIdManager.FEATURE_CONTEXT_KEY] = componentIdManager
        }
    ...
    override fun onStop() {
        ...
        componentIdManager = NoOpComponentIdManager()
