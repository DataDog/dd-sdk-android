...
Java_com_datadog_android_rum_profiling_Profiler_startTracing(JNIEnv *env, jobject /* this */, jlong samplingInterval,
    ...
    pe_cfg.set_remote_descriptor_timeout_ms(10000);
    ...
    // Add process stats data source
    auto *process_stats = cfg.add_data_sources()->mutable_config();
    process_stats->set_name("linux.process_stats");
