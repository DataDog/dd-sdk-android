...
import com.datadog.android.rum.assertj.AppLaunchVitalEventAssert
...
import com.datadog.android.rum.internal.domain.scope.toAppLaunchVitalSchemaType
...
import com.datadog.android.rum.internal.toAppLaunchVital
...
internal class RumSessionScopeStartupManagerTest {
    ...
    private fun verifyTTID(value: RumVitalAppLaunchEvent, info: RumTTIDInfo) {
        AppLaunchVitalEventAssert.assertThat(value).apply {
            ...
            hasSessionType(fakeRumSessionType?.toAppLaunchVital() ?: RumVitalAppLaunchEvent.RumVitalAppLaunchEventSessionType.USER)
            hasNoSessionReplay()
            hasNullView()
            ...
            hasDeviceInfo(
                ...
                fakeDatadogContext.deviceInfo.deviceType.toAppLaunchVitalSchemaType(),
        ...
        assertThat(vital).apply {
            ...
            hasStartupType(info.scenario.toVitalStartupType())
            hasPrewarmed(null)
