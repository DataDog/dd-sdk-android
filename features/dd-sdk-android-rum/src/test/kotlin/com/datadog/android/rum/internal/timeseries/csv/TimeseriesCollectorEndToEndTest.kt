...
internal class TimeseriesCollectorEndToEndTest {
    ...
    fun `set up`(forge: Forge) {
        ...
        val testedTimeseries = CsvCollector.create(
        ...
        capturedMemoryEvents = testedTimeseries.captured.mapNotNull { serializedPayload ->
            runCatching { TimeseriesMemoryEvent.fromJsonObject(serializedPayload) }
                .getOrNull()
        }
        capturedCpuEvents = testedTimeseries.captured.mapNotNull { serializedPayload ->
