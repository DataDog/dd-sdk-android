        ...
        return TelemetryConfigurationEvent(
            ...
            telemetry = TelemetryConfigurationEvent.Telemetry(
                configuration = TelemetryConfigurationEvent.Configuration(
                    ...
                    profilingSampleRate = forge.aNullable { aFloat(min = 0f, max = 100f) },
                    profilingApplicationLaunchSampleRate = forge.aNullable { aFloat(min = 0f, max = 100f) },
                    profilingAnrEnabled = forge.aNullable { aBool() },
