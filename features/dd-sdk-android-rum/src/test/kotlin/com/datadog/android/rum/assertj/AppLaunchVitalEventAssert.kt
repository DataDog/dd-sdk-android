...
import com.datadog.android.rum.internal.domain.scope.toAppLaunchVitalSessionPrecondition
import com.datadog.android.rum.model.RumVitalAppLaunchEvent
import org.assertj.core.api.AbstractObjectAssert
import org.assertj.core.api.Assertions.assertThat

internal class AppLaunchVitalEventAssert(
    actual: RumVitalAppLaunchEvent
) : AbstractObjectAssert<AppLaunchVitalEventAssert, RumVitalAppLaunchEvent>(
    actual,
    AppLaunchVitalEventAssert::class.java
) {
    ...
    fun hasStartReason(reason: RumSessionScope.StartReason) = apply {
        assertThat(actual.dd.session?.sessionPrecondition)
            ...
            .isEqualTo(reason.toAppLaunchVitalSessionPrecondition())
    }
    ...
    companion object {
        internal fun assertThat(actual: RumVitalAppLaunchEvent): AppLaunchVitalEventAssert = AppLaunchVitalEventAssert(actual)
    }
}
