...
object RumContextTestsUtils {
    ...
    fun Forge.aRumContext(sessionId: Long? = null, sessionSampleRate: Float? = null) = buildMap {
        ...
        put(RUM_CONTEXT_SESSION_SAMPLE_RATE, sessionSampleRate ?: aFloat(min = 0f, max = 100f))
        sessionId?.let {
            put(
