...
public class OtelSpanBuilder implements SpanBuilder {
  ...
  public SpanBuilder setParent(Context context) {
    AgentSpan.Context extractedContext = OtelExtractedContext.extract(context);
  ...
  public SpanBuilder setAttribute(String key, String value) {
    ...
    if (OtelConventions.OPERATION_NAME_SPECIFIC_ATTRIBUTE.equals(key) && value != null) {
      this.overriddenOperationName = value.toLowerCase(ROOT);
      return this;
    } else if (OtelConventions.ANALYTICS_EVENT_SPECIFIC_ATTRIBUTES.equals(key) && value != null) {
  ...
  public SpanBuilder setAttribute(String key, boolean value) {
    // Check reserved attributes
    if (OtelConventions.ANALYTICS_EVENT_SPECIFIC_ATTRIBUTES.equals(key)) {
  ...
  public SpanBuilder setSpanKind(SpanKind spanKind) {
    if (spanKind != null) {
      this.delegate.withTag(SPAN_KIND, OtelConventions.toSpanKindTagValue(spanKind));
