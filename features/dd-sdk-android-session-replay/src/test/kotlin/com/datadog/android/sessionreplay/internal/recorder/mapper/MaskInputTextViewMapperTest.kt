...
internal class MaskInputTextViewMapperTest : BaseTextViewWireframeMapperTest() {
    ...
    @Test
    fun `M use the MaskInputObfuscationRule as defaultObfuscator when initialized`() {
        // When
        val textViewMapper = MaskInputTextViewMapper(
            mockViewIdentifierResolver,
            mockColorStringFormatter,
            mockViewBoundsResolver,
            mockDrawableToColorMapper
        ...
        assertThat(textViewMapper.textValueObfuscationRule)
            .isInstanceOf(MaskInputObfuscationRule::class.java)
    }
}
