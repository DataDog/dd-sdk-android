...
internal class TextViewMapperTest : BaseWireframeMapperTest() {
    ...
    fun `set up`() {
        ...
        testedTextWireframeMapper = TextViewMapper(
    ...
    private fun TextView.toTextWireframes(): List<MobileSegment.Wireframe.TextWireframe> {
    ...
    fun `M resolve a TextWireframe W map() { TextView with fontStyle }`(
        ...
        val expectedWireframes = mockTextView.toTextWireframes().map {
            it.copy(
                text = resolveExpectedText(mockTextView),
                textStyle = MobileSegment.TextStyle(
                    expectedFontFamily,
    ...
    private fun resolveExpectedText(textView: TextView): String {
        val obfuscationRule = when (fakeMappingContext.privacy) {
        ...
        return obfuscationRule.resolveObfuscatedValue(textView, fakeMappingContext)
    }
}
