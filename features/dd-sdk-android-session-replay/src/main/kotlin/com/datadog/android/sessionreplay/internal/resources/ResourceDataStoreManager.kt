...
internal class ResourceDataStoreManager(
    ...
    private val storedLastUpdateDateNs = AtomicLong(featureSdkCore.timeProvider.getDeviceElapsedTimeNs())
    ...
    private fun didDataStoreExpire(lastUpdateDate: Long): Boolean =
        featureSdkCore.timeProvider.getDeviceElapsedTimeNs() - lastUpdateDate > DATASTORE_EXPIRATION_NS
