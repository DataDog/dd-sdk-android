...
internal open class SwitchCompatMapper(
    ...
    private fun createTrackWireframe(
        ...
        return trackBounds?.let {
            ...
            return mappingContext.imageWireframeHelper.createImageWireframe(
                ...
                x = trackBounds.x.densityNormalized(mappingContext.systemInformation.screenDensity)
                    .toLong(),
                y = trackBounds.y.densityNormalized(mappingContext.systemInformation.screenDensity)
                    .toLong(),
    ...
    private fun createThumbWireframe(
        ...
        return thumbBounds?.let { thumbBounds ->
            mappingContext.imageWireframeHelper.createImageWireframe(
                view = view,
                imagePrivacy = mapInputPrivacyToImagePrivacy(mappingContext.textAndInputPrivacy),
                currentWireframeIndex = prevIndex + 1,
                x = thumbBounds.x.densityNormalized(mappingContext.systemInformation.screenDensity)
                    .toLong(),
                y = thumbBounds.y.densityNormalized(mappingContext.systemInformation.screenDensity)
                    .toLong(),
