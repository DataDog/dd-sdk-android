...
internal class ResourceResolver private constructor(
    ...
    internal fun resolveResourceId(
        ...
        if (resourceId != null) {
            ...
            resourcesSerializerCallback.onReady(resourceId)
            return
        }
            ...
            createBitmapAsync(
                ...
                resolveResourceCallback = object : ResolveResourceCallback {
                    override fun onResolved(resourceId: String, byteArray: ByteArray) {
                        resourceItemCreationHandler.queueItemIfNotPreviouslySeen(resourceId, byteArray)
                        resourcesSerializerCallback.onReady(resourceId)
                    }

                    override fun onFailed() {
                        resourcesSerializerCallback.onReady(null)
                    }
                }
            )
        }.let {
