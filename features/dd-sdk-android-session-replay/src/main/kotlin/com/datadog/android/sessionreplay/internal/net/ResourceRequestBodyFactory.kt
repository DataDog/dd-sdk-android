...
internal class ResourceRequestBodyFactory(
    ...
    internal fun deserializeToResourceEvents(resources: List<RawBatchEvent>): List<ResourceEvent> {
        return resources.mapNotNull {
            ...
            if (resourceMetadata != null) {
                ...
                println("*** deserializeToResourceEvents $mimeType ***")
    ...
    @Suppress("TooGenericExceptionCaught")
    private fun addResourceRequestBody(builder: MultipartBody.Builder, filename: String, resourceData: ByteArray, mimeType: String? = null) {
        val body = try {
            println("*** filename: $filename - mimeType: $mimeType ***")
