 ...
 */
@Suppress("TooManyFunctions") // Compose decomposition and native-view traversal are split by concern, not size.
internal class AndroidWindowTraversal(
    ...
    private fun recurseIntoNativeChildren(
        ...
        val occludedIndices = occlusionDetector.occludedChildIndices(view, state.screenDensity)
