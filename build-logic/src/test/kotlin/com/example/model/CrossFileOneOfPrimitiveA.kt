 ...
 */
public data class CrossFileOneOfPrimitiveA(
    ...
    public companion object {
        ...
        public fun fromJson(jsonString: String): CrossFileOneOfPrimitiveA {
            try {
                val jsonObject = JsonParser.parseString(jsonString).asJsonObject
                return fromJsonObject(jsonObject)
            } catch (e: IllegalStateException) {
                throw JsonParseException(
                    "Unable to parse json into type CrossFileOneOfPrimitiveA",
                    e
                )
            }
        }
        ...
        @JvmStatic
        @Throws(JsonParseException::class)
        public fun fromJsonObject(jsonObject: JsonObject): CrossFileOneOfPrimitiveA {
            try {
                val path = jsonObject.get("path").let {
                    Path.fromJsonElement(it)
                }
                return CrossFileOneOfPrimitiveA(path)
            } catch (e: IllegalStateException) {
                throw JsonParseException(
                    "Unable to parse json into type CrossFileOneOfPrimitiveA",
                    e
