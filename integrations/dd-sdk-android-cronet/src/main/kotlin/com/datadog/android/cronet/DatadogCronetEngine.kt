...
class DatadogCronetEngine internal constructor(
    ...
    override fun newUrlRequestBuilder(
        ...
        val datadogCallback = DatadogRequestCallback(callback, apmNetworkInstrumentation)
    ...
    class Builder : CronetEngine.Builder {
        ...
        fun enableRumInstrumentation(
            configuration: RumNetworkInstrumentationConfiguration = RumNetworkInstrumentationConfiguration()
        ) = apply {
            rumNetworkInstrumentationConfiguration = configuration
        }
        ...
        private var rumNetworkInstrumentationConfiguration: RumNetworkInstrumentationConfiguration? = null
        ...
        override fun build(): CronetEngine {
            val rumResourceInstrumentation = rumNetworkInstrumentationConfiguration?.let {
