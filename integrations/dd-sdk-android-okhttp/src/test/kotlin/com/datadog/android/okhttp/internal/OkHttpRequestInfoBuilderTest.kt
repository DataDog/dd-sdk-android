...
internal class OkHttpRequestInfoBuilderTest {
    ...
    fun `M remove header W removeHeader()`(
        ...
        // When
        val result = testedModifier.removeHeader(headerKey).build()
    ...
    fun `M not affect other headers W removeHeader()`(
        ...
        // When
        val result = testedModifier.removeHeader(headerKey1).build()
    ...
    fun `M remove tag W addTag() { null value }`(
        ...
        // When
        val result = testedModifier.addTag(String::class.java, null).build()
    ...
    fun `M replace header W replaceHeader()`(
        ...
        // When
        val result = testedModifier.replaceHeader(headerKey, newValue).build()
