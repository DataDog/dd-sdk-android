...
fun OkHttpClient.Builder.configureDatadogInstrumentation(
    apmInstrumentationConfiguration: ApmNetworkInstrumentationConfiguration? = null,
    rumInstrumentationConfiguration: RumNetworkInstrumentationConfiguration? = null
...
class OkHttpIntegrationPlugin internal constructor(
    ...
    fun eventListener(eventListener: EventListener) = apply {
        ...
        this.userEventListenerFactory = eventListener.asFactory()
    }
    ...
    internal companion object {
        ...
        const val OKHTTP_NETWORK_INSTRUMENTATION_NAME = "okhttp"
    }
}
