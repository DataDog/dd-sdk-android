...
public abstract class BaseActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(baseActivityIsToolbarActionBarEnabled()) {
			...
			ActionBar supportActionBarOrThrow = getSupportActionBarOrThrow();
			supportActionBarOrThrow.setCustomView(R.layout.actionbar_title);
			supportActionBarOrThrow.setDisplayShowCustomEnabled(true);
			supportActionBarOrThrow.setDisplayShowTitleEnabled(false);
