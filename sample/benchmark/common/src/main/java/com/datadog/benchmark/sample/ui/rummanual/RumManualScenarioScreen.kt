...
@Composable
fun RumManualScenarioScreenPreview() {
    RumManualScenarioScreen(
        modifier = Modifier.fillMaxSize(),
        state = RumManualScenarioState.INITIAL.copy(
            config = RumManualScenarioState.INITIAL.config.copy(eventType = RumManualScenarioState.RumEventType.ERROR)
        ),
        dispatch = {}
    )
}
