...
class RumAutoScenarioActivity : BaseScenarioActivity() {
    @Inject
    lateinit var rumAutoScenarioNavigator: RumAutoScenarioNavigator

    @Inject
    lateinit var navigationGraphInitializer: NavigationGraphInitializer

    @Inject
    lateinit var benchmarkConfig: BenchmarkConfig
...
val Activity.benchmarkActivityComponent: BenchmarkActivityComponent
