...
abstract class BenchmarkApplication : Application() {

    lateinit var benchmarkAppComponent: BenchmarkAppComponent
...
val Context.benchmarkAppComponent: BenchmarkAppComponent
