...
/**
 * Benchmarks for Zstd compression using the pure Java :zstd-java module.
 * 
 * This uses a pure Java implementation (Airlift) without native code.
 */
@RunWith(AndroidJUnit4::class)
class ZstdJavaBenchmark {
    ...
    @Test
    fun compress_smallPayload_zstdJava() {
        benchmarkRule.measureRepeated {
            compressWithZstdJava(payloadSmall)
        }
    }

    @Test
    fun compress_mediumPayload_zstdJava() {
        benchmarkRule.measureRepeated {
            compressWithZstdJava(payloadMedium)
        }
    }
    ...
    @Test
    fun compress_logsPayload_zstdJava() {
        benchmarkRule.measureRepeated {
            compressWithZstdJava(payloadLogs)
        }
    }
