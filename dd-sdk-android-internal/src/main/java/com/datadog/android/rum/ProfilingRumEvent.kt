 ...
 *
 * @param success True if the profiling was successful, false otherwise
 * @param errorCode The error code of the profiling
 * @param errorMessage The error message of the profiling
 * @param duration The duration of the profiling
 * @param fileSize The file size of the profiling
 */
