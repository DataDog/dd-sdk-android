...
{{< img src="real_user_monitoring/android/android-mobile-vitals-new.png" alt="Mobile Vitals in the RUM Explorer" style="width:70%;">}}
...
[7]: https://docs.datadoghq.com/real_user_monitoring/error_tracking/android
