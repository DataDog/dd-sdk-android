...
internal class ConfigurationBuilderTest {
    ...
    fun `𝕄 sanitize hosts 𝕎 setFirstPartyHosts()`(
        ...
        verify(mockSanitizer)
            .sanitizeHosts(
                hosts,
                Configuration.WARNING_USING_URL_FOR_HOST,
                Configuration.ERROR_MALFORMED_URL,
                Configuration.ERROR_MALFORMED_HOST_IP_ADDRESS
            )
    }
    ...
    fun `𝕄 sanitize hosts 𝕎 setWebViewTrackingHosts()`(
        ...
        verify(mockSanitizer)
            .sanitizeHosts(
                hosts,
                Configuration.WARNING_USING_URL_FOR_WEBVIEW_HOST,
                Configuration.ERROR_MALFORMED_URL_FOR_WEBVIEW_HOST,
                Configuration.ERROR_MALFORMED_HOST_IP_ADDRESS_FOR_WEBVIEW_HOST
            )
    }
