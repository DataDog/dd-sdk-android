...
internal class WebInternalLogsFeatureTest :
    SdkFeatureTest<WebLogEvent, Configuration.Feature.InternalLogs, WebInternalLogsFeature>() {

    override fun createTestedFeature(): WebInternalLogsFeature {
        return WebInternalLogsFeature
    }
    ...
    fun `𝕄 initialize persistence strategy 𝕎 initialize()`() {
        ...
        assertThat(testedFeature.persistenceStrategy)
            .isInstanceOf(WebInternalLogFilePersistenceStrategy::class.java)
    }
