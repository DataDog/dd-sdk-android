...
internal class InternalLogFileStrategyTest {
    lateinit var testedStrategy: InternalLogFileStrategy
    ...
    fun `set up`() {
        ...
        testedStrategy = InternalLogFileStrategy(
            mockedContext,
    ...
    fun `M correctly initialise the strategy W instantiated`() {
        ...
        val expectedIntermediateFolderPath =
            absolutePath +
                File.separator +
                InternalLogFileStrategy.INTERMEDIATE_DATA_FOLDER
        val expectedAuthorizedFolderPath =
            absolutePath +
                File.separator +
                InternalLogFileStrategy.AUTHORIZED_FOLDER
