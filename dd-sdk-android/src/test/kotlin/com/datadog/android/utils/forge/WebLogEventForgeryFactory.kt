...
internal class WebLogEventForgeryFactory : ForgeryFactory<WebLogEvent> {
    override fun getForgery(forge: Forge): WebLogEvent {
        ...
        return WebLogEvent(
            ...
            status = forge.aValueFrom(WebLogEvent.Status::class.java),
