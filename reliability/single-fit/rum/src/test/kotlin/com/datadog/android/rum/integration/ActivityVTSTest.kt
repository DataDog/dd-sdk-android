    ...
    fun `M send RUM View W onActivityResumed()`() {
        ...
        assertThat(eventsWritten)
            ...
            .hasRumEvent(index = 0) {
                ...
                hasSource("android")
                hasType("view")
                hasViewUrl("com/datadog/android/rum/integration/ActivityVTSTest/StubActivity")
                hasViewName("com.datadog.android.rum.integration.ActivityVTSTest.StubActivity")
            }
    }
