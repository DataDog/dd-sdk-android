...
class ViewUpdateAssert(
    ...
    class ViewUpdateEventViewAssert(
        ...
        fun hasLoadingTime(loadingTime: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.loadingTime)
                .overridingErrorMessage("Expected view.loadingTime to be <%s> but was <%s>", loadingTime, actual.loadingTime)
        ...
        fun hasNetworkSettledTime(networkSettledTime: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.networkSettledTime)
                .overridingErrorMessage("Expected view.networkSettledTime to be <%s> but was <%s>", networkSettledTime, actual.networkSettledTime)
        ...
        fun hasInteractionToNextViewTime(interactionToNextViewTime: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.interactionToNextViewTime)
                .overridingErrorMessage("Expected view.interactionToNextViewTime to be <%s> but was <%s>", interactionToNextViewTime, actual.interactionToNextViewTime)
        ...
        fun hasLoadingType(loadingType: ViewUpdateEvent.LoadingType?): ViewUpdateEventViewAssert {
            assertThat(actual.loadingType)
                .overridingErrorMessage("Expected view.loadingType to be <%s> but was <%s>", loadingType, actual.loadingType)
        ...
        fun hasFirstContentfulPaint(firstContentfulPaint: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.firstContentfulPaint)
                .overridingErrorMessage("Expected view.firstContentfulPaint to be <%s> but was <%s>", firstContentfulPaint, actual.firstContentfulPaint)
        ...
        fun hasLargestContentfulPaint(largestContentfulPaint: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.largestContentfulPaint)
                .overridingErrorMessage("Expected view.largestContentfulPaint to be <%s> but was <%s>", largestContentfulPaint, actual.largestContentfulPaint)
        ...
        fun hasLargestContentfulPaintTargetSelector(selector: String?): ViewUpdateEventViewAssert {
            assertThat(actual.largestContentfulPaintTargetSelector)
                .overridingErrorMessage("Expected view.largestContentfulPaintTargetSelector to be <%s> but was <%s>", selector, actual.largestContentfulPaintTargetSelector)
                .isEqualTo(selector)
            return this
        }
        ...
        fun hasFirstInputDelay(firstInputDelay: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.firstInputDelay)
                .overridingErrorMessage("Expected view.firstInputDelay to be <%s> but was <%s>", firstInputDelay, actual.firstInputDelay)
        ...
        fun hasFirstInputTime(firstInputTime: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.firstInputTime)
                .overridingErrorMessage("Expected view.firstInputTime to be <%s> but was <%s>", firstInputTime, actual.firstInputTime)
        ...
        fun hasFirstInputTargetSelector(selector: String?): ViewUpdateEventViewAssert {
            assertThat(actual.firstInputTargetSelector)
                .overridingErrorMessage("Expected view.firstInputTargetSelector to be <%s> but was <%s>", selector, actual.firstInputTargetSelector)
                .isEqualTo(selector)
            return this
        }
        ...
        fun hasInteractionToNextPaint(interactionToNextPaint: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.interactionToNextPaint)
                .overridingErrorMessage("Expected view.interactionToNextPaint to be <%s> but was <%s>", interactionToNextPaint, actual.interactionToNextPaint)
        ...
        fun hasInteractionToNextPaintTime(time: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.interactionToNextPaintTime)
                .overridingErrorMessage("Expected view.interactionToNextPaintTime to be <%s> but was <%s>", time, actual.interactionToNextPaintTime)
                .isEqualTo(time)
            return this
        }
        ...
        fun hasInteractionToNextPaintTargetSelector(selector: String?): ViewUpdateEventViewAssert {
            assertThat(actual.interactionToNextPaintTargetSelector)
                .overridingErrorMessage("Expected view.interactionToNextPaintTargetSelector to be <%s> but was <%s>", selector, actual.interactionToNextPaintTargetSelector)
                .isEqualTo(selector)
            return this
        }
        ...
        fun hasCumulativeLayoutShift(cumulativeLayoutShift: Number?): ViewUpdateEventViewAssert {
            assertThat(actual.cumulativeLayoutShift)
                .overridingErrorMessage("Expected view.cumulativeLayoutShift to be <%s> but was <%s>", cumulativeLayoutShift, actual.cumulativeLayoutShift)
        ...
        fun hasCumulativeLayoutShiftTime(time: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.cumulativeLayoutShiftTime)
                .overridingErrorMessage("Expected view.cumulativeLayoutShiftTime to be <%s> but was <%s>", time, actual.cumulativeLayoutShiftTime)
                .isEqualTo(time)
            return this
        }
        ...
        fun hasCumulativeLayoutShiftTargetSelector(selector: String?): ViewUpdateEventViewAssert {
            assertThat(actual.cumulativeLayoutShiftTargetSelector)
                .overridingErrorMessage("Expected view.cumulativeLayoutShiftTargetSelector to be <%s> but was <%s>", selector, actual.cumulativeLayoutShiftTargetSelector)
                .isEqualTo(selector)
            return this
        }
        ...
        fun hasDomComplete(domComplete: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.domComplete)
                .overridingErrorMessage("Expected view.domComplete to be <%s> but was <%s>", domComplete, actual.domComplete)
        ...
        fun hasDomContentLoaded(domContentLoaded: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.domContentLoaded)
                .overridingErrorMessage("Expected view.domContentLoaded to be <%s> but was <%s>", domContentLoaded, actual.domContentLoaded)
        ...
        fun hasDomInteractive(domInteractive: Long?): ViewUpdateEventViewAssert {
            assertThat(actual.domInteractive)
                .overridingErrorMessage("Expected view.domInteractive to be <%s> but was <%s>", domInteractive, actual.domInteractive)
        ...
        fun hasIsSlowRendered(isSlowRendered: Boolean?): ViewUpdateEventViewAssert {
            assertThat(actual.isSlowRendered)
                .overridingErrorMessage("Expected view.isSlowRendered to be <%s> but was <%s>", isSlowRendered, actual.isSlowRendered)
        ...
        fun hasMemoryAverage(memoryAverage: Number?): ViewUpdateEventViewAssert {
            assertThat(actual.memoryAverage)
                .overridingErrorMessage("Expected view.memoryAverage to be <%s> but was <%s>", memoryAverage, actual.memoryAverage)
        ...
        fun hasCpuTicksCount(cpuTicksCount: Number?): ViewUpdateEventViewAssert {
            assertThat(actual.cpuTicksCount)
                .overridingErrorMessage("Expected view.cpuTicksCount to be <%s> but was <%s>", cpuTicksCount, actual.cpuTicksCount)
        ...
        fun hasCpuTicksPerSecond(cpuTicksPerSecond: Number?): ViewUpdateEventViewAssert {
            assertThat(actual.cpuTicksPerSecond)
                .overridingErrorMessage("Expected view.cpuTicksPerSecond to be <%s> but was <%s>", cpuTicksPerSecond, actual.cpuTicksPerSecond)
        ...
        fun hasRefreshRateAverage(refreshRateAverage: Number?): ViewUpdateEventViewAssert {
            assertThat(actual.refreshRateAverage)
                .overridingErrorMessage("Expected view.refreshRateAverage to be <%s> but was <%s>", refreshRateAverage, actual.refreshRateAverage)
        ...
        fun hasRefreshRateMin(refreshRateMin: Number?): ViewUpdateEventViewAssert {
            assertThat(actual.refreshRateMin)
                .overridingErrorMessage("Expected view.refreshRateMin to be <%s> but was <%s>", refreshRateMin, actual.refreshRateMin)
        ...
        fun hasSlowFramesRate(slowFramesRate: Number?): ViewUpdateEventViewAssert {
            assertThat(actual.slowFramesRate)
                .overridingErrorMessage("Expected view.slowFramesRate to be <%s> but was <%s>", slowFramesRate, actual.slowFramesRate)
        ...
        fun hasSlowFrames(slowFrames: List<ViewUpdateEvent.SlowFrame>?): ViewUpdateEventViewAssert {
            assertThat(actual.slowFrames)
                .overridingErrorMessage("Expected view.slowFrames to be <%s> but was <%s>", slowFrames, actual.slowFrames)
        ...
        fun hasInForegroundPeriods(periods: List<ViewUpdateEvent.InForegroundPeriod>?): ViewUpdateEventViewAssert {
            assertThat(actual.inForegroundPeriods)
                .overridingErrorMessage("Expected view.inForegroundPeriods to be <%s> but was <%s>", periods, actual.inForegroundPeriods)
                .isEqualTo(periods)
            return this
        }
    ...
    class ViewUpdateEventSessionAssert(
        ...
        fun hasSampledForReplay(sampledForReplay: Boolean?): ViewUpdateEventSessionAssert {
            assertThat(actual.sampledForReplay)
                .overridingErrorMessage("Expected session.sampledForReplay to be <%s> but was <%s>", sampledForReplay, actual.sampledForReplay)
        ...
        fun hasHasReplay(hasReplay: Boolean?): ViewUpdateEventSessionAssert {
            assertThat(actual.hasReplay)
                .overridingErrorMessage("Expected session.hasReplay to be <%s> but was <%s>", hasReplay, actual.hasReplay)
                .isEqualTo(hasReplay)
            return this
        }
    }
    ...
    class ApplicationAssert(
        ...
        fun hasCurrentLocale(currentLocale: String?): ApplicationAssert {
            assertThat(actual.currentLocale)
                .overridingErrorMessage("Expected application.currentLocale to be <%s> but was <%s>", currentLocale, actual.currentLocale)
    ...
    class DdAssert(
        ...
        fun hasDocumentVersion(documentVersion: Long): DdAssert {
            assertThat(actual.documentVersion)
                .overridingErrorMessage("Expected dd.documentVersion to be <%s> but was <%s>", documentVersion, actual.documentVersion)
        ...
        fun hasFormatVersion(formatVersion: Long): DdAssert {
            assertThat(actual.formatVersion)
                .overridingErrorMessage("Expected dd.formatVersion to be <%s> but was <%s>", formatVersion, actual.formatVersion)
        ...
        fun hasBrowserSdkVersion(browserSdkVersion: String?): DdAssert {
            assertThat(actual.browserSdkVersion)
                .overridingErrorMessage("Expected dd.browserSdkVersion to be <%s> but was <%s>", browserSdkVersion, actual.browserSdkVersion)
    ...
    class FeatureFlagsAssert(
        ...
        fun hasAdditionalProperties(additionalProperties: Map<String, Any?>): FeatureFlagsAssert {
            assertThat(actual.additionalProperties)
                .overridingErrorMessage("Expected featureFlags.additionalProperties to be <%s> but was <%s>", additionalProperties, actual.additionalProperties)
    ...
    class PrivacyAssert(
        ...
        fun hasReplayLevel(replayLevel: ViewUpdateEvent.ReplayLevel): PrivacyAssert {
            assertThat(actual.replayLevel)
                .overridingErrorMessage("Expected privacy.replayLevel to be <%s> but was <%s>", replayLevel, actual.replayLevel)
    ...
    class ScrollAssert(
        ...
        fun hasMaxDepthScrollTop(maxDepthScrollTop: Number): ScrollAssert {
            assertThat(actual.maxDepthScrollTop)
                .overridingErrorMessage("Expected scroll.maxDepthScrollTop to be <%s> but was <%s>", maxDepthScrollTop, actual.maxDepthScrollTop)
        ...
        fun hasMaxScrollHeight(maxScrollHeight: Number): ScrollAssert {
            assertThat(actual.maxScrollHeight)
                .overridingErrorMessage("Expected scroll.maxScrollHeight to be <%s> but was <%s>", maxScrollHeight, actual.maxScrollHeight)
        ...
        fun hasMaxScrollHeightTime(maxScrollHeightTime: Number): ScrollAssert {
            assertThat(actual.maxScrollHeightTime)
                .overridingErrorMessage("Expected scroll.maxScrollHeightTime to be <%s> but was <%s>", maxScrollHeightTime, actual.maxScrollHeightTime)
    ...
    class UsrAssert(
        ...
        fun hasAnonymousId(anonymousId: String?): UsrAssert {
            assertThat(actual.anonymousId)
                .overridingErrorMessage("Expected usr.anonymousId to be <%s> but was <%s>", anonymousId, actual.anonymousId)
    ...
    class ConnectivityAssert(
        ...
        fun hasInterfaces(interfaces: List<ViewUpdateEvent.Interface>?): ConnectivityAssert {
            assertThat(actual.interfaces)
                .overridingErrorMessage("Expected connectivity.interfaces to be <%s> but was <%s>", interfaces, actual.interfaces)
        ...
        fun hasEffectiveType(effectiveType: ViewUpdateEvent.EffectiveType?): ConnectivityAssert {
            assertThat(actual.effectiveType)
                .overridingErrorMessage("Expected connectivity.effectiveType to be <%s> but was <%s>", effectiveType, actual.effectiveType)
    ...
    class CellularAssert(
        ...
        fun hasTechnology(technology: String?): CellularAssert {
            assertThat(actual.technology)
                .overridingErrorMessage("Expected cellular.technology to be <%s> but was <%s>", technology, actual.technology)
        ...
        fun hasCarrierName(carrierName: String?): CellularAssert {
            assertThat(actual.carrierName)
                .overridingErrorMessage("Expected cellular.carrierName to be <%s> but was <%s>", carrierName, actual.carrierName)
    ...
    class SyntheticsAssert(
        ...
        fun hasResultId(resultId: String): SyntheticsAssert {
            assertThat(actual.resultId)
                .overridingErrorMessage("Expected synthetics.resultId to be <%s> but was <%s>", resultId, actual.resultId)
                .isEqualTo(resultId)
            return this
        }
        ...
        fun hasInjected(injected: Boolean?): SyntheticsAssert {
            assertThat(actual.injected)
                .overridingErrorMessage("Expected synthetics.injected to be <%s> but was <%s>", injected, actual.injected)
                .isEqualTo(injected)
            return this
        }
    }
    ...
    class CiTestAssert(
        ...
        fun hasTestExecutionId(testExecutionId: String): CiTestAssert {
            assertThat(actual.testExecutionId)
                .overridingErrorMessage("Expected ciTest.testExecutionId to be <%s> but was <%s>", testExecutionId, actual.testExecutionId)
    ...
    class OsAssert(
        ...
        fun hasVersionMajor(versionMajor: String): OsAssert {
            assertThat(actual.versionMajor)
                .overridingErrorMessage("Expected os.versionMajor to be <%s> but was <%s>", versionMajor, actual.versionMajor)
    ...
    class DeviceAssert(
        ...
        fun hasArchitecture(architecture: String?): DeviceAssert {
            assertThat(actual.architecture)
                .overridingErrorMessage("Expected device.architecture to be <%s> but was <%s>", architecture, actual.architecture)
        ...
        fun hasBatteryLevel(batteryLevel: Number?): DeviceAssert {
            assertThat(actual.batteryLevel)
                .overridingErrorMessage("Expected device.batteryLevel to be <%s> but was <%s>", batteryLevel, actual.batteryLevel)
        ...
        fun hasPowerSavingMode(powerSavingMode: Boolean?): DeviceAssert {
            assertThat(actual.powerSavingMode)
                .overridingErrorMessage("Expected device.powerSavingMode to be <%s> but was <%s>", powerSavingMode, actual.powerSavingMode)
        ...
        fun hasBrightnessLevel(brightnessLevel: Number?): DeviceAssert {
            assertThat(actual.brightnessLevel)
                .overridingErrorMessage("Expected device.brightnessLevel to be <%s> but was <%s>", brightnessLevel, actual.brightnessLevel)
        ...
        fun hasLogicalCpuCount(logicalCpuCount: Number?): DeviceAssert {
            assertThat(actual.logicalCpuCount)
                .overridingErrorMessage("Expected device.logicalCpuCount to be <%s> but was <%s>", logicalCpuCount, actual.logicalCpuCount)
    ...
    class DdSessionAssert(
        ...
        fun hasSessionPrecondition(sessionPrecondition: ViewUpdateEvent.SessionPrecondition?): DdSessionAssert {
            assertThat(actual.sessionPrecondition)
                .overridingErrorMessage("Expected dd.session.sessionPrecondition to be <%s> but was <%s>", sessionPrecondition, actual.sessionPrecondition)
    ...
    class ConfigurationAssert(
        ...
        fun hasSessionSampleRate(sessionSampleRate: Number): ConfigurationAssert {
            assertThat(actual.sessionSampleRate)
                .overridingErrorMessage("Expected configuration.sessionSampleRate to be <%s> but was <%s>", sessionSampleRate, actual.sessionSampleRate)
        ...
        fun hasSessionReplaySampleRate(sessionReplaySampleRate: Number?): ConfigurationAssert {
            assertThat(actual.sessionReplaySampleRate)
                .overridingErrorMessage("Expected configuration.sessionReplaySampleRate to be <%s> but was <%s>", sessionReplaySampleRate, actual.sessionReplaySampleRate)
        ...
        fun hasProfilingSampleRate(profilingSampleRate: Number?): ConfigurationAssert {
            assertThat(actual.profilingSampleRate)
                .overridingErrorMessage("Expected configuration.profilingSampleRate to be <%s> but was <%s>", profilingSampleRate, actual.profilingSampleRate)
        ...
        fun hasTraceSampleRate(traceSampleRate: Number?): ConfigurationAssert {
            assertThat(actual.traceSampleRate)
                .overridingErrorMessage("Expected configuration.traceSampleRate to be <%s> but was <%s>", traceSampleRate, actual.traceSampleRate)
    ...
    class CustomTimingsAssert(
        ...
        fun hasAdditionalProperties(additionalProperties: Map<String, Long>): CustomTimingsAssert {
            assertThat(actual.additionalProperties)
                .overridingErrorMessage("Expected customTimings.additionalProperties to be <%s> but was <%s>", additionalProperties, actual.additionalProperties)
                .isEqualTo(additionalProperties)
            return this
        }
    ...
    class FlutterBuildTimeAssert(
        ...
        fun hasAverage(average: Number): FlutterBuildTimeAssert {
            assertThat(actual.average)
                .overridingErrorMessage("Expected flutterBuildTime.average to be <%s> but was <%s>", average, actual.average)
                .isEqualTo(average)
            return this
        }
        ...
        fun hasMetricMax(metricMax: Number?): FlutterBuildTimeAssert {
            assertThat(actual.metricMax)
                .overridingErrorMessage("Expected flutterBuildTime.metricMax to be <%s> but was <%s>", metricMax, actual.metricMax)
                .isEqualTo(metricMax)
            return this
        }
    }
    ...
    class ClsAssert(
        ...
        fun hasTargetSelector(targetSelector: String?): ClsAssert {
            assertThat(actual.targetSelector)
                .overridingErrorMessage("Expected cls.targetSelector to be <%s> but was <%s>", targetSelector, actual.targetSelector)
    ...
    class FidAssert(
        ...
        fun hasTargetSelector(targetSelector: String?): FidAssert {
            assertThat(actual.targetSelector)
                .overridingErrorMessage("Expected fid.targetSelector to be <%s> but was <%s>", targetSelector, actual.targetSelector)
                .isEqualTo(targetSelector)
            return this
        }
    }
    ...
    class InpAssert(
        ...
        fun hasTargetSelector(targetSelector: String?): InpAssert {
            assertThat(actual.targetSelector)
                .overridingErrorMessage("Expected inp.targetSelector to be <%s> but was <%s>", targetSelector, actual.targetSelector)
                .isEqualTo(targetSelector)
            return this
        }

        fun subParts(block: InpSubPartsAssert.() -> Unit): InpAssert {
            assertThat(actual.subParts)
                .overridingErrorMessage("Expected inp.subParts to be non-null but was null")
                .isNotNull
            InpSubPartsAssert(actual.subParts!!).block()
            return this
        }
    }
    ...
    class InpSubPartsAssert(
        ...
        fun hasInputDelay(inputDelay: Long): InpSubPartsAssert {
            assertThat(actual.inputDelay)
                .overridingErrorMessage("Expected inp.subParts.inputDelay to be <%s> but was <%s>", inputDelay, actual.inputDelay)
                .isEqualTo(inputDelay)
            return this
        }

        fun hasProcessingTime(processingTime: Long): InpSubPartsAssert {
            assertThat(actual.processingTime)
                .overridingErrorMessage("Expected inp.subParts.processingTime to be <%s> but was <%s>", processingTime, actual.processingTime)
                .isEqualTo(processingTime)
            return this
        }

        fun hasPresentationDelay(presentationDelay: Long): InpSubPartsAssert {
            assertThat(actual.presentationDelay)
                .overridingErrorMessage("Expected inp.subParts.presentationDelay to be <%s> but was <%s>", presentationDelay, actual.presentationDelay)
                .isEqualTo(presentationDelay)
            return this
        }
    }
    ...
    class LcpAssert(
        ...
        fun hasTargetSelector(targetSelector: String?): LcpAssert {
            assertThat(actual.targetSelector)
                .overridingErrorMessage("Expected lcp.targetSelector to be <%s> but was <%s>", targetSelector, actual.targetSelector)
                .isEqualTo(targetSelector)
            return this
        }
        ...
        fun hasResourceUrl(resourceUrl: String?): LcpAssert {
            assertThat(actual.resourceUrl)
                .overridingErrorMessage("Expected lcp.resourceUrl to be <%s> but was <%s>", resourceUrl, actual.resourceUrl)
                .isEqualTo(resourceUrl)
            return this
        }

        fun subParts(block: LcpSubPartsAssert.() -> Unit): LcpAssert {
            assertThat(actual.subParts)
                .overridingErrorMessage("Expected lcp.subParts to be non-null but was null")
                .isNotNull
            LcpSubPartsAssert(actual.subParts!!).block()
            return this
        }
    }
    ...
    class LcpSubPartsAssert(
        ...
        fun hasLoadDelay(loadDelay: Long): LcpSubPartsAssert {
            assertThat(actual.loadDelay)
                .overridingErrorMessage("Expected lcp.subParts.loadDelay to be <%s> but was <%s>", loadDelay, actual.loadDelay)
                .isEqualTo(loadDelay)
            return this
        }

        fun hasLoadTime(loadTime: Long): LcpSubPartsAssert {
            assertThat(actual.loadTime)
                .overridingErrorMessage("Expected lcp.subParts.loadTime to be <%s> but was <%s>", loadTime, actual.loadTime)
                .isEqualTo(loadTime)
            return this
        }

        fun hasRenderDelay(renderDelay: Long): LcpSubPartsAssert {
            assertThat(actual.renderDelay)
                .overridingErrorMessage("Expected lcp.subParts.renderDelay to be <%s> but was <%s>", renderDelay, actual.renderDelay)
                .isEqualTo(renderDelay)
            return this
        }
    }
    ...
    class AccessibilityAssert(
        ...
        fun hasTextSize(textSize: String?): AccessibilityAssert {
            assertThat(actual.textSize)
                .overridingErrorMessage("Expected accessibility.textSize to be <%s> but was <%s>", textSize, actual.textSize)
                .isEqualTo(textSize)
            return this
        }
        ...
        fun hasScreenReaderEnabled(screenReaderEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.screenReaderEnabled)
                .overridingErrorMessage("Expected accessibility.screenReaderEnabled to be <%s> but was <%s>", screenReaderEnabled, actual.screenReaderEnabled)
        ...
        fun hasBoldTextEnabled(boldTextEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.boldTextEnabled)
                .overridingErrorMessage("Expected accessibility.boldTextEnabled to be <%s> but was <%s>", boldTextEnabled, actual.boldTextEnabled)
        ...
        fun hasReduceTransparencyEnabled(reduceTransparencyEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.reduceTransparencyEnabled)
                .overridingErrorMessage("Expected accessibility.reduceTransparencyEnabled to be <%s> but was <%s>", reduceTransparencyEnabled, actual.reduceTransparencyEnabled)
        ...
        fun hasReduceMotionEnabled(reduceMotionEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.reduceMotionEnabled)
                .overridingErrorMessage("Expected accessibility.reduceMotionEnabled to be <%s> but was <%s>", reduceMotionEnabled, actual.reduceMotionEnabled)
        ...
        fun hasButtonShapesEnabled(buttonShapesEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.buttonShapesEnabled)
                .overridingErrorMessage("Expected accessibility.buttonShapesEnabled to be <%s> but was <%s>", buttonShapesEnabled, actual.buttonShapesEnabled)
        ...
        fun hasInvertColorsEnabled(invertColorsEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.invertColorsEnabled)
                .overridingErrorMessage("Expected accessibility.invertColorsEnabled to be <%s> but was <%s>", invertColorsEnabled, actual.invertColorsEnabled)
        ...
        fun hasIncreaseContrastEnabled(increaseContrastEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.increaseContrastEnabled)
                .overridingErrorMessage("Expected accessibility.increaseContrastEnabled to be <%s> but was <%s>", increaseContrastEnabled, actual.increaseContrastEnabled)
        ...
        fun hasAssistiveSwitchEnabled(assistiveSwitchEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.assistiveSwitchEnabled)
                .overridingErrorMessage("Expected accessibility.assistiveSwitchEnabled to be <%s> but was <%s>", assistiveSwitchEnabled, actual.assistiveSwitchEnabled)
        ...
        fun hasAssistiveTouchEnabled(assistiveTouchEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.assistiveTouchEnabled)
                .overridingErrorMessage("Expected accessibility.assistiveTouchEnabled to be <%s> but was <%s>", assistiveTouchEnabled, actual.assistiveTouchEnabled)
        ...
        fun hasVideoAutoplayEnabled(videoAutoplayEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.videoAutoplayEnabled)
                .overridingErrorMessage("Expected accessibility.videoAutoplayEnabled to be <%s> but was <%s>", videoAutoplayEnabled, actual.videoAutoplayEnabled)
        ...
        fun hasClosedCaptioningEnabled(closedCaptioningEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.closedCaptioningEnabled)
                .overridingErrorMessage("Expected accessibility.closedCaptioningEnabled to be <%s> but was <%s>", closedCaptioningEnabled, actual.closedCaptioningEnabled)
        ...
        fun hasMonoAudioEnabled(monoAudioEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.monoAudioEnabled)
                .overridingErrorMessage("Expected accessibility.monoAudioEnabled to be <%s> but was <%s>", monoAudioEnabled, actual.monoAudioEnabled)
        ...
        fun hasShakeToUndoEnabled(shakeToUndoEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.shakeToUndoEnabled)
                .overridingErrorMessage("Expected accessibility.shakeToUndoEnabled to be <%s> but was <%s>", shakeToUndoEnabled, actual.shakeToUndoEnabled)
        ...
        fun hasReducedAnimationsEnabled(reducedAnimationsEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.reducedAnimationsEnabled)
                .overridingErrorMessage("Expected accessibility.reducedAnimationsEnabled to be <%s> but was <%s>", reducedAnimationsEnabled, actual.reducedAnimationsEnabled)
        ...
        fun hasShouldDifferentiateWithoutColor(shouldDifferentiateWithoutColor: Boolean?): AccessibilityAssert {
            assertThat(actual.shouldDifferentiateWithoutColor)
                .overridingErrorMessage("Expected accessibility.shouldDifferentiateWithoutColor to be <%s> but was <%s>", shouldDifferentiateWithoutColor, actual.shouldDifferentiateWithoutColor)
        ...
        fun hasGrayscaleEnabled(grayscaleEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.grayscaleEnabled)
                .overridingErrorMessage("Expected accessibility.grayscaleEnabled to be <%s> but was <%s>", grayscaleEnabled, actual.grayscaleEnabled)
        ...
        fun hasSingleAppModeEnabled(singleAppModeEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.singleAppModeEnabled)
                .overridingErrorMessage("Expected accessibility.singleAppModeEnabled to be <%s> but was <%s>", singleAppModeEnabled, actual.singleAppModeEnabled)
        ...
        fun hasOnOffSwitchLabelsEnabled(onOffSwitchLabelsEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.onOffSwitchLabelsEnabled)
                .overridingErrorMessage("Expected accessibility.onOffSwitchLabelsEnabled to be <%s> but was <%s>", onOffSwitchLabelsEnabled, actual.onOffSwitchLabelsEnabled)
        ...
        fun hasSpeakScreenEnabled(speakScreenEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.speakScreenEnabled)
                .overridingErrorMessage("Expected accessibility.speakScreenEnabled to be <%s> but was <%s>", speakScreenEnabled, actual.speakScreenEnabled)
        ...
        fun hasSpeakSelectionEnabled(speakSelectionEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.speakSelectionEnabled)
                .overridingErrorMessage("Expected accessibility.speakSelectionEnabled to be <%s> but was <%s>", speakSelectionEnabled, actual.speakSelectionEnabled)
        ...
        fun hasRtlEnabled(rtlEnabled: Boolean?): AccessibilityAssert {
            assertThat(actual.rtlEnabled)
                .overridingErrorMessage("Expected accessibility.rtlEnabled to be <%s> but was <%s>", rtlEnabled, actual.rtlEnabled)
