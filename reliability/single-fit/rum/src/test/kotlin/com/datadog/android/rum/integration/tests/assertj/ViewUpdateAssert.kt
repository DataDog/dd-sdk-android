...
class ViewUpdateAssert(
    ...
    /**
     * Asserts that all optional top-level fields are null.
     * This is a convenience method to reduce boilerplate in tests.
     */
    fun hasNoOptionalFields(): ViewUpdateAssert {
        hasNoFeatureFlags()
        hasNoContainer()
        hasNoPrivacy()
        hasNoDisplay()
    ...
    class ViewUpdateEventViewAssert(
        ...
        /**
         * Asserts that all optional platform-specific view fields are null.
         * This is a convenience method to reduce boilerplate in tests.
         * Note: Does not include hasNoCustomTimings() since custom timings may be set in tests.
         */
        fun hasNoOptionalViewFields(): ViewUpdateEventViewAssert {
