...
class LoggerTest {
    ...
    fun `M send log with defaults W Logger#log()`(
        ...
        assertThat(event0.getString("ddtags")).contains("service:" + stubSdkCore.getDatadogContext().service)
    ...
    fun `M send log with custom service W Logger#Builder#setService() + Logger#log()`(
        ...
        assertThat(event0.getString("ddtags")).contains("version:" + stubSdkCore.getDatadogContext().version)
        assertThat(event0.getString("ddtags")).contains("variant:" + stubSdkCore.getDatadogContext().variant)
        assertThat(event0.getString("ddtags")).contains("service:" + fakeServiceName.lowercase(Locale.US))
