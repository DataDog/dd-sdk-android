...
* [FEATURE] Partial RUM View Updates:
  - Add the `view_update` JSON schema and refactor shared view properties. See [#3287](https://github.com/DataDog/dd-sdk-android/pull/3287)
  - Add the `DiffBuilder` utility and `ViewUpdateEvent` diff computation. See [#3296](https://github.com/DataDog/dd-sdk-android/pull/3296)
  - Implement the `view_update` event pipeline. See [#3299](https://github.com/DataDog/dd-sdk-android/pull/3299)
  - Add `replay_stats`, `profiling`, `page_states`, `cls`, and `configuration` to `ViewUpdateEvent._dd`. See [#3575](https://github.com/DataDog/dd-sdk-android/pull/3575)
  - Use `AlwaysFullView` as the default `RumViewEventWriteConfig`. See [#3591](https://github.com/DataDog/dd-sdk-android/pull/3591)
  - Add periodic full-view checkpoints. See [#3677](https://github.com/DataDog/dd-sdk-android/pull/3677)
  - Complete the Partial RUM View Updates integration. See [#3809](https://github.com/DataDog/dd-sdk-android/pull/3809)
* [FEATURE] APM Client-Side Stats:
  - Add `statsComputationEnabled` to `TraceConfiguration`. See [#3490](https://github.com/DataDog/dd-sdk-android/pull/3490)
  - Add APM client-side stats models and an encoder. See [#3487](https://github.com/DataDog/dd-sdk-android/pull/3487)
  - Add the `DDSketch` implementation. See [#3509](https://github.com/DataDog/dd-sdk-android/pull/3509)
  - Create and register a stub for the client stats feature when enabled. See [#3523](https://github.com/DataDog/dd-sdk-android/pull/3523)
  - Implement client stats aggregation. See [#3529](https://github.com/DataDog/dd-sdk-android/pull/3529)
  - Integrate the client stats systems into `ClientStatsFeature`. See [#3564](https://github.com/DataDog/dd-sdk-android/pull/3564)
  - Aggregate each trace for stats as a single unit. See [#3578](https://github.com/DataDog/dd-sdk-android/pull/3578)
  - Disable server-side stats for spans processed by client-side stats. See [#3588](https://github.com/DataDog/dd-sdk-android/pull/3588)
  - Prevent client stats aggregation without tracking consent. See [#3581](https://github.com/DataDog/dd-sdk-android/pull/3581)
  - Decrease the client stats flush interval to 30 seconds. See [#3599](https://github.com/DataDog/dd-sdk-android/pull/3599)
  - Mark sampled-out network spans as droppable while preserving stats. See [#3596](https://github.com/DataDog/dd-sdk-android/pull/3596)
  - Mark client-side stats APIs with `ExperimentalTraceApi`. See [#3644](https://github.com/DataDog/dd-sdk-android/pull/3644)
  - Complete the APM Client-Side Stats integration. See [#3823](https://github.com/DataDog/dd-sdk-android/pull/3823)
* [FEATURE] Remote Configuration support:
  - Add Remote Configuration schemas. See [#3605](https://github.com/DataDog/dd-sdk-android/pull/3605)
  - Fetch and store Remote Configuration files. See [#3610](https://github.com/DataDog/dd-sdk-android/pull/3610)
  - Add an `OkHttp` cache to `RemoteConfigNetworkFetcher` for ETag-based conditional requests. See [#3617](https://github.com/DataDog/dd-sdk-android/pull/3617)
  - Refresh `RemoteConfigService` when the app enters the foreground. See [#3650](https://github.com/DataDog/dd-sdk-android/pull/3650)
  - Apply Remote Configuration to `RumConfiguration` in `Rum.enable()`. See [#3656](https://github.com/DataDog/dd-sdk-android/pull/3656)
  - Apply Remote Configuration to `SessionReplayConfiguration` in `SessionReplay.enable()`. See [#3655](https://github.com/DataDog/dd-sdk-android/pull/3655)
  - Apply Remote Configuration to `ProfilingConfiguration` in `Profiling.enable()`. See [#3657](https://github.com/DataDog/dd-sdk-android/pull/3657)
  - Add `remoteConfigurationId` to `DatadogContext` and RUM `ViewEvent`. See [#3665](https://github.com/DataDog/dd-sdk-android/pull/3665)
  - Apply Remote Configuration to the Trace module when the SDK instance is ready. See [#3663](https://github.com/DataDog/dd-sdk-android/pull/3663)
  - Update the Remote Configuration schema. See [#3686](https://github.com/DataDog/dd-sdk-android/pull/3686)
  - Complete the Remote Configuration implementation. See [#3761](https://github.com/DataDog/dd-sdk-android/pull/3761)
  - Expose `Configuration.Builder.setRemoteConfigurationId(String)` as a public API. See [#3853](https://github.com/DataDog/dd-sdk-android/pull/3853)
* [FEATURE] Configurable Flags initialization timeout. See [#3693](https://github.com/DataDog/dd-sdk-android/pull/3693)
* [BUGFIX] Harden the JVM crash exception handler. See [#3769](https://github.com/DataDog/dd-sdk-android/pull/3769)
* [BUGFIX] Allow `StrictMode` disk writes while deleting Remote Configuration files. See [#3776](https://github.com/DataDog/dd-sdk-android/pull/3776)
* [BUGFIX] Fix `DataUploadScheduler.stopScheduling()` behavior. See [#3767](https://github.com/DataDog/dd-sdk-android/pull/3767)
* [BUGFIX] Fix `ViewEventMapper` identity handling in `RumViewEventWriter`. See [#3813](https://github.com/DataDog/dd-sdk-android/pull/3813)
* [BUGFIX] Restore accessibility-change deduplication for full `ViewEvent` writes. See [#3814](https://github.com/DataDog/dd-sdk-android/pull/3814)
* [BUGFIX] Use a sleep-inclusive clock for session timeouts and inactivity. See [#3811](https://github.com/DataDog/dd-sdk-android/pull/3811)
* [BUGFIX] Preserve tracking consent in stub SDK contexts. See [#3815](https://github.com/DataDog/dd-sdk-android/pull/3815)
* [BUGFIX] Add MAUI to `RumErrorSourceType`. See [#3830](https://github.com/DataDog/dd-sdk-android/pull/3830)
* [BUGFIX] Discard ANR profiles until upload support is available. See [#3847](https://github.com/DataDog/dd-sdk-android/pull/3847)
* [BUGFIX] Use device boot time to compute Profiling duration. See [#3848](https://github.com/DataDog/dd-sdk-android/pull/3848)
* [BUGFIX] Fix OpenFeature `Value.String` serialization during evaluation context conversion. See [#3849](https://github.com/DataDog/dd-sdk-android/pull/3849)
* [IMPROVEMENT] Increase the maximum attribute count to 1,900. See [#3724](https://github.com/DataDog/dd-sdk-android/pull/3724)
* [IMPROVEMENT] Update the RUM Debug Widget legend. See [#3794](https://github.com/DataDog/dd-sdk-android/pull/3794)
* [IMPROVEMENT] Align the `timeseries` API with iOS. See [#3826](https://github.com/DataDog/dd-sdk-android/pull/3826)
* [MAINTENANCE] Bump `cronetApi` to version `143.7445.0`. See [#3793](https://github.com/DataDog/dd-sdk-android/pull/3793)
...
* [FEATURE] Support interstitial Activities case for TTID reporting:
  - Add predicate to filter Activities for TTID reporting. See [#3173](https://github.com/DataDog/dd-sdk-android/pull/3173)
  - Auto-forward TTID to next activity for interstitial pattern. See [#3199](https://github.com/DataDog/dd-sdk-android/pull/3199)
* [FEATURE] Capture `OkHttp` network headers. See [#3204](https://github.com/DataDog/dd-sdk-android/pull/3204)
* [BUGFIX] Fix `RecorderWindowCallback` crash on null menu parameter. See [#3239](https://github.com/DataDog/dd-sdk-android/pull/3239)
* [BUGFIX] Use variant key instead of value in RUM feature flag tracking. See [#3245](https://github.com/DataDog/dd-sdk-android/pull/3245)
* [BUGFIX] Update Proguard rules for `GlobalDatadogTracer`. See [#3251](https://github.com/DataDog/dd-sdk-android/pull/3251)
* [BUGFIX] Fix memory corruption in NDK module. See [#3257](https://github.com/DataDog/dd-sdk-android/pull/3257)
* [BUGFIX] Fix stale state context mismatch. See [#3224](https://github.com/DataDog/dd-sdk-android/pull/3224)
* [BUGFIX] Fix duplicate spans. See [#3267](https://github.com/DataDog/dd-sdk-android/pull/3267)
* [IMPROVEMENT] Telemetry support for Cronet integration. See [#3210](https://github.com/DataDog/dd-sdk-android/pull/3210)
* [IMPROVEMENT] Remove `PII` from `WebView` event error logging. See [#3250](https://github.com/DataDog/dd-sdk-android/pull/3250)
* [IMPROVEMENT] Exempt telemetry configuration event from the session event count limit. See [#3248](https://github.com/DataDog/dd-sdk-android/pull/3248)
* [IMPROVEMENT] Propagate trace and session replay sample rates to RUM `ViewEvents`. See [#3247](https://github.com/DataDog/dd-sdk-android/pull/3247)
* [IMPROVEMENT] Reduce `.so` file size. See [#3190](https://github.com/DataDog/dd-sdk-android/pull/3190)
* [IMPROVEMENT] Implement deterministic RUM session sampling. See [#3264](https://github.com/DataDog/dd-sdk-android/pull/3264)
* [IMPROVEMENT] Downgrade `androidx-core` to `1.15.0` in order to preserve Android `compileSdk 35` compatibility. See [#3266](https://github.com/DataDog/dd-sdk-android/pull/3266)
* [IMPROVEMENT] Update profiling telemetry with more data. See [#3240](https://github.com/DataDog/dd-sdk-android/pull/3240)
* [IMPROVEMENT] Use schema defined in `rum-events-format `to generate `ProfileEvent`. See [#3268](https://github.com/DataDog/dd-sdk-android/pull/3268)
* [MAINTENANCE] Fix self-referential test assertions in serialization round-trip tests. See [#3242](https://github.com/DataDog/dd-sdk-android/pull/3242)
* [MAINTENANCE] Fix flaky `AppStartupActivityPredicateTest`. See [#3218](https://github.com/DataDog/dd-sdk-android/pull/3218)
* [MAINTENANCE] Migrate to unified `InternalLoggerUtils`. See [#3241](https://github.com/DataDog/dd-sdk-android/pull/3241)
* [MAINTENANCE] Add Claude skill: `android-sdk-event-inspection`. See [#3220](https://github.com/DataDog/dd-sdk-android/pull/3220)
* [MAINTENANCE] Add basic AI dev tooling. See [#3243](https://github.com/DataDog/dd-sdk-android/pull/3243)
...
* [MAINTENANCE] Avoid logging test assumptions failures to stderr. See [#3263](https://github.com/DataDog/dd-sdk-android/pull/3263)
* [MAINTENANCE] Update Gradle to version `9.4.0`. See [#3258](https://github.com/DataDog/dd-sdk-android/pull/3258)
* [MAINTENANCE] Remove deprecation suppression from `Path.computeBounds` call site. See [#3265](https://github.com/DataDog/dd-sdk-android/pull/3265)
...
* [FEATURE] APM support for Cronet instrumentation:
  - Support for RUM <> APM integration for Cronet. See [#3136](https://github.com/DataDog/dd-sdk-android/pull/3136)
  - Support for APM instrumentation on network layer for Cronet. See [#3171](https://github.com/DataDog/dd-sdk-android/pull/3171)
* [FEATURE] Feature Flags Evaluation Logging:
  - Event Schema & Data Models. See [#3144](https://github.com/DataDog/dd-sdk-android/pull/3144)
  - Storage & Network Infrastructure. See [#3146](https://github.com/DataDog/dd-sdk-android/pull/3146)
  - Aggregation Engine & Test Utilities. See [#3145](https://github.com/DataDog/dd-sdk-android/pull/3145)
  - Integration. See [#3147](https://github.com/DataDog/dd-sdk-android/pull/3147)
  - Flag evaluation schema. See [#3166](https://github.com/DataDog/dd-sdk-android/pull/3166)
  - Evaluations subfeature. See [#3159](https://github.com/DataDog/dd-sdk-android/pull/3159)
  - Evaluation aggregation followup. See [#3178](https://github.com/DataDog/dd-sdk-android/pull/3178)
  - Use time-based periodic flush instead of cancel+reschedule. See [#3189](https://github.com/DataDog/dd-sdk-android/pull/3189)
* [BUGFIX] Fix missing feature flags in crash and ANR error events. See [#3172](https://github.com/DataDog/dd-sdk-android/pull/3172)
* [BUGFIX] Fix global attributes not copied when view stops. See [#3177](https://github.com/DataDog/dd-sdk-android/pull/3177)
* [BUGFIX] Fix evaluations feature startup deadlock. See [#3186](https://github.com/DataDog/dd-sdk-android/pull/3186)
* [BUGFIX] Fix typo in the CPU metric name of RUM Debug widget. See [#3188](https://github.com/DataDog/dd-sdk-android/pull/3188)
* [BUGFIX] Fix missing error tracking in `resolve()` API. See [#3187](https://github.com/DataDog/dd-sdk-android/pull/3187)
* [BUGFIX] Address `ConcurrentModificationException` in the RUM pipeline. See [#3196](https://github.com/DataDog/dd-sdk-android/pull/3196)
* [BUGFIX] Fix more concurrency issues. See [#3197](https://github.com/DataDog/dd-sdk-android/pull/3197)
* [IMPROVEMENT] Support custom view instrumentation types for cross-platform SDKs. See [#3167](https://github.com/DataDog/dd-sdk-android/pull/3167) 
* [IMPROVEMENT] Use read lock for `removeListener`. See [#3132](https://github.com/DataDog/dd-sdk-android/pull/3132)
* [IMPROVEMENT] Add Profiling start reason for synthetics test. See [#3160](https://github.com/DataDog/dd-sdk-android/pull/3160)
* [IMPROVEMENT] Fix `stopResourceWithError` overloads to use `getEventTime(attributes)`. See [#3155](https://github.com/DataDog/dd-sdk-android/pull/3155)
* [IMPROVEMENT] Include SDK name/version for flag config requests. See [#3162](https://github.com/DataDog/dd-sdk-android/pull/3162)
* [IMPROVEMENT] Remove `KeepAlive` event in RUM. See [#3079](https://github.com/DataDog/dd-sdk-android/pull/3079)
* [IMPROVEMENT] Improve `InsightsCollector.kt` methods signatures. See [#3207](https://github.com/DataDog/dd-sdk-android/pull/3207)
* [IMPROVEMENT] Add GraphQL errors support for cross-platform SDKs. See [#3201](https://github.com/DataDog/dd-sdk-android/pull/3201)
* [IMPROVEMENT] Lower `LayoutNodeUtils` telemetry to `warning` with call site information. See [#3208](https://github.com/DataDog/dd-sdk-android/pull/3208)
* [IMPROVEMENT] Add `totalRam`, `logicalCpuCount` and `isLowRam` to `DeviceInfo`. See [#3024](https://github.com/DataDog/dd-sdk-android/pull/3024)
* [IMPROVEMENT] Update RUM schema. See [#3193](https://github.com/DataDog/dd-sdk-android/pull/3193)
* [IMPROVEMENT] Avoid blocking context call at the Flags feature initialization. See [#3194](https://github.com/DataDog/dd-sdk-android/pull/3194)
* [IMPROVEMENT] Address a warning about `ConcurrentHashMap` parametrized with nullable value type. See [#3195](https://github.com/DataDog/dd-sdk-android/pull/3195)
* [IMPROVEMENT] Improve ANR detector runnable. See [#3192](https://github.com/DataDog/dd-sdk-android/pull/3192)
* [IMPROVEMENT] Close precomputed assignments response body. See [#3198](https://github.com/DataDog/dd-sdk-android/pull/3198)
* [MAINTENANCE] Fix NPE in `TracingInterceptor` tests. See [#3181](https://github.com/DataDog/dd-sdk-android/pull/3181)
* [MAINTENANCE] Redirect `TraceStructureWriter` default output from stderr to stdout. See [#3191](https://github.com/DataDog/dd-sdk-android/pull/3191)
* [MAINTENANCE] Fix JSON model generation task caching. See [#3179](https://github.com/DataDog/dd-sdk-android/pull/3179)
* [MAINTENANCE] Use `develop` build cache as a fallback in Gitlab CI jobs. See [#3140](https://github.com/DataDog/dd-sdk-android/pull/3140)
* [MAINTENANCE] Make `ViewLoadingTimeMetrics` tests deterministic and faster with controlled time. See [#3154](https://github.com/DataDog/dd-sdk-android/pull/3154)
...
* [IMPROVEMENT] Flags: Add support for global flags via `EvaluationContext.EMPTY`. See [#3104](https://github.com/DataDog/dd-sdk-android/pull/3104)
...
* [FEATURE] Add a Jetpack Compose fine grained masking override API. See [#2416](https://github.com/DataDog/dd-sdk-android/pull/2416)
* [FEATURE] Implement the basic logic for `interaction-to-next-view-metric`. See [#2417](https://github.com/DataDog/dd-sdk-android/pull/2417)
* [FEATURE] Support `is_main_process` property in telemetry configuration. See [#2422](https://github.com/DataDog/dd-sdk-android/pull/2422)
* [FEATURE] Introduce the `setNetworkSettledInitialResourceIdentifier` API. See [#2424](https://github.com/DataDog/dd-sdk-android/pull/2424)
* [FEATURE] Introduce the `setLastInteractionIdentifier` public API. See [#2428](https://github.com/DataDog/dd-sdk-android/pull/2428)
* [IMPROVEMENT] Refactor `TextSemanticsNodeMapper` to commonize the text wireframe logic. See [#2401](https://github.com/DataDog/dd-sdk-android/pull/2401)
* [IMPROVEMENT] Add `TextField` semantics mapper for Session Replay Compose. See [#2406](https://github.com/DataDog/dd-sdk-android/pull/2406) 
* [IMPROVEMENT] Decouple Jetpack Compose reflection functions and report to Telemetry. See [#2415](https://github.com/DataDog/dd-sdk-android/pull/2415)
* [IMPROVEMENT] Move `ImageSemanticsMapper` reflection functions into `ReflectionUtils`. See [#2419](https://github.com/DataDog/dd-sdk-android/pull/2419)
* [IMPROVEMENT] Handle readOnly `additionalProperties`. See [#2423](https://github.com/DataDog/dd-sdk-android/pull/2423)
...
* [IMPROVEMENT] Correctly handle `TTNS` when a resource was stopped with an error. See [#2444](https://github.com/DataDog/dd-sdk-android/pull/2444)
* [IMPROVEMENT] Add integration tests for the `TTNS` metric. See [#2442](https://github.com/DataDog/dd-sdk-android/pull/2442)
* [IMPROVEMENT] Add integration tests for `ITNV` metric. See [#2445](https://github.com/DataDog/dd-sdk-android/pull/2445)
* [IMPROVEMENT] Display captured text when the text has `Ellipsis` overflow. See [#2446](https://github.com/DataDog/dd-sdk-android/pull/2446)
* [IMPROVEMENT] Support interop view from Jetpack Compose. See [#2452](https://github.com/DataDog/dd-sdk-android/pull/2452)
* [IMPROVEMENT] Add an "effective sample rate" to telemetry events. See [#2453](https://github.com/DataDog/dd-sdk-android/pull/2453)
* [IMPROVEMENT] Handle traces with coroutines. See [#2457](https://github.com/DataDog/dd-sdk-android/pull/2457)
* [IMPROVEMENT] Add support for Jetpack Compose Checkbox. See [#2414](https://github.com/DataDog/dd-sdk-android/pull/2414)
* [IMPROVEMENT] Replace `joinToString` when possible. See [#2456](https://github.com/DataDog/dd-sdk-android/pull/2456)
* [MAINTENANCE] Fix flaky test in the Deterministic Sampler. See [#2412](https://github.com/DataDog/dd-sdk-android/pull/2412) 
